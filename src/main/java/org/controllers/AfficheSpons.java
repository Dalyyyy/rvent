...
public class AfficheSpons implements Initializable {
    ...
    private final SponService spon = new SponService();
    private List <Sponsoring> sponListe = new ArrayList<>();
    ...
    void intitialisationProduitList() {
        int row = 0;
        try {
            for (Sponsoring sponsoring : sponListe) {
                FXMLLoader loader = new FXMLLoader(new File("C:/Users/SAFWEN/IdeaProjects/rvent/src/main/resources/card.fxml").toURI().toURL());
                AnchorPane item = loader.load();

                cardController cardController = loader.getController();
                cardController.setData(sponsoring);
                ...
                grid.add(item, 0, row);
                GridPane.setMargin(item, new Insets(30));
                ...
                rowConstraints.setPercentHeight(100 / sponListe.size()); // Each row takes an equal percentage of the height
    ...
    public void ajouterProduitOnClick(ActionEvent event) throws IOException {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(new File("C:/Users/SAFWEN/IdeaProjects/rvent/src/main/resources/entrepriseSpons.fxml").toURI().toURL());
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            sponListe = spon.afficher();
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        System.out.println(sponListe);
    ...
    public void modifier(Sponsoring sponsoring) {
        //sponsoring.setFakeIdP(sponsoring.getId_prod());
        //System.out.println(produit.getFakeIdP());
        System.out.println("initializeData called with produitfake: " + sponsoring);
        ...
        try {
            ...
            // itemCardController.setData(sponsoring);
            Stage stage = new Stage();
